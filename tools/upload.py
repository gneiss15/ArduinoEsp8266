...
try:
    sys.path.insert( 0, os.path.join( ToolsDir, "pyserial" ) ) # Add pyserial dir to search path
    sys.path.insert( 0, os.path.join( ToolsDir, "esptool" ) ) # Add esptool dir to search path
